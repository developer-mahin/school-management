...
//   const school = await getSchoolByRole(user) as any;
...
//     const findSchool = await User.findOne({ _id: school?.userId }) as any

//     const userPayload = {
//       userId: findSchool?._id,
//       studentId: user.studentId,
//       parentsId: user.parentsId,
//       schoolId: findSchool?.schoolId,
//       teacherId: user.teacherId,
//       managerId: user.managerId,
//       phoneNumber: findSchool?.phoneNumber,
//       role: findSchool?.role,
//       name: findSchool?.name,
//       image: findSchool?.image,
//       mySchoolUserId: school?.userId,
//       mySchoolId: school?._id,
//     };

//     managerToSchoolToken = generateToken(
//       userPayload,
//       config.jwt.access_token as Secret,
//       config.jwt.access_expires_in as string,
//     );
...
//   let adminToSupperAdmin
//   if (user.role === USER_ROLE.admin) {
//     const findSupperAdmin = await User.findById(superAdmin?._id) as any

//     const userPayload = {
//       userId: findSupperAdmin?._id,
//       adminId: user?._id,
//       phoneNumber: findSupperAdmin?.phoneNumber,
//       role: findSupperAdmin?.role,
//       name: findSupperAdmin?.name,
//       image: findSupperAdmin?.image,
//     };

//     adminToSupperAdmin = generateToken(
//       userPayload,
//       config.jwt.access_token as Secret,
//       config.jwt.access_expires_in as string,
//     );
